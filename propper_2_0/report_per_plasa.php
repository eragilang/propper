		...
		<div id="page_content_assess"><!--content-->
			...
			if ($nbcsr > 0){
			   ...
			   <tr align="right">
	            ...
	            $logger->setDBConnection($gatepnp);
	     		...
	     		$logger->Logging(HistoryType::HISTORYTYPE_VIEW_REPORT_PLASA,$userid,"View Report Plasa $unitid Periode $selmonth - $selyear",$ipaddress);
					}
					?>   	
			</div><!--left column-->
			...
			<div id="right_column"><!--right column-->
  				<div class="section"><!--latest news-->
  					<p class="highlight">Plasa</p>
  					<form action="report_per_plasa.php" method="post">
  					<?php
				try{
  					$channel = "SELECT 
					  			unit_id, 
				    ...
				    $plasares = $gatecsdm->ExecuteQuery($channel,"csdm");
