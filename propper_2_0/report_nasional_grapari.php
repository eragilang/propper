		...
		<div id="page_content_assess"><!--content-->
    		...
    		foreach ($arrOfShopInRegional as $regname => $arrOfUnit){
	            ...
	            $logger->setDBConnection($gatepnp);
	     		...
	     		$logger->Logging(HistoryType::HISTORYTYPE_VIEW_REPORT_GRAPARI_NASIONAL,$userid,"View Report Nasional GraPARI Periode $selmonth - $selyear",$ipaddress);
			...
			<div id="right_column"><!--right column-->
  				<div class="section"><!--latest news-->
  					<form action="report_nasional_grapari.php" method="post">
