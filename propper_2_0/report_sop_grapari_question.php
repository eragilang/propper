...
<div id="mainwrap">
    ...
    <a href="report_sop_grapari_all.php" >All GraPARI </a>&bull;
    Question per GraPARI &bull;
...
<div class="newsletterbox">
    <form name='frmQuiz' action='report_sop_grapari_question.php' method='post' id='frmQuiz'>
<h3> <a href="#" title="Score">GraPARI</a></h3>
  <p style="margin: 8px 0pt 6px 50px;" id='numberCountdown'>
  <?
        try{
            $gerai = "SELECT unit_id, unit_name FROM csdm2.t_unit_branch WHERE unit_type='grapari' order by 2 asc";
