...
<div id="mainwrap">
    ...
    <div id="content">
    Report CSR &bull;
    <a href="#" >Report SOP ID</a> &bull;
    <a href="#" >Report Area</a> &bull;
        ...
        /* try */ {
            ...
            if ($unitid != 0){
                $repsql ="SELECT ".
                         ...
                         "  employee_code ".
                         "FROM ".
                         "  csdm.csdm_employee ce, ".
                         "  pnp.score_detail s, ".
                         "  pnp.category ca, ".
                         "  pnp.question_active qa, ".
                         "  csdm.csdm_channel_grapari cg ".
                         "WHERE ".
                         ...
                         "  cg.channel_service_id = ce.channel_service_id and ".
                         "  ca.cat_group = '3.0' and s.set_id = 1 and ".
                         "  cg.channel_service_id = $unitid ".
                         "GROUP BY ".
                         "  employee_code,".
                         "  product ".
                         "order by 1,2;";
...
<div class="newsletterbox">
    <form name='frmQuiz' action='report_sop.php' method='post' id='frmQuiz'>
