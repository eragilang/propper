...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" lang="de"><head>
    ...
    <title>:: PNP Assessment :: Report All Call Center</title>
        ...
        try{
			...
			//echo $repsql;
                    ...
                    echo "<table class='report' cellpadding='0' cellspacing='0'>".
                        "<tr>".
                        "<td class='header params' rowspan='2'>Call Center</td>".
			...
			foreach($arrOfCSR as $csid => $csname){
			   echo "<tr>";
                        echo "<td class='valuel params'><a href='report_sop.php?uid=$csid&thn=$selyear&bln=$selmonth'>$csname</a></td>";
				...
				echo "<td class='valuer month'><a href='report_sop_cc_question.php?uid=$csid&thn=$selyear&bln=$selmonth'>$correct</a></td>";
				echo "<td class='valuer month'><a href='report_sop_cc_question.php?uid=$csid&thn=$selyear&bln=$selmonth'>$wrong</a></td>";
				$arrOfTotal[$pid]["B"] += $correct;
                    ...
                    echo "<td class='valuer month' style='background-color:#CCC;'> <a href='report_sop_cc_question_all.php?thn=$selyear&bln=$selmonth'>".$arrOfTotal[1]["B"]."</a></td>";
		      echo "<td class='valuer month' style='background-color:#CCC;'> <a href='report_sop_cc_question_all.php?thn=$selyear&bln=$selmonth'>".$arrOfTotal[1]["S"]."</a></td>";
                    echo "<td class='valuer month' style='background-color:#CCC;'> <a href='report_sop_cc_question_all.php?thn=$selyear&bln=$selmonth'>".$arrOfTotal[2]["B"]."</a></td>";
		      echo "<td class='valuer month' style='background-color:#CCC;'> <a href='report_sop_cc_question_all.php?thn=$selyear&bln=$selmonth'>".$arrOfTotal[2]["S"]."</a></td>";
                    echo "<td class='valuer month' style='background-color:#CCC;'> <a href='report_sop_cc_question_all.php?thn=$selyear&bln=$selmonth'>".$arrOfTotal[3]["B"]."</a></td>";
                    echo "<td class='valuer month' style='background-color:#CCC;'> <a href='report_sop_cc_question_all.php?thn=$selyear&bln=$selmonth'>".$arrOfTotal[3]["S"]."</a></td>";
			echo "</tr>";
...
<div class="newsletterbox">
    <form name='frmQuiz' action='report_sop_cc_all.php' method='post' id='frmQuiz'>
