<?php
    ...
    if (isset($_REQUEST["btnUploadSoal"])){
        ...
        echo "<script language=\"javascript\">window.open('tes_upload.php?rnum=$rnum&idrand=$idrand','uploadsoal','height=600,width=1000,top=30,left=150,center=yes,toolbar=no,scrollbars=yes,status=no,menubar=no,location=no');</script>";
