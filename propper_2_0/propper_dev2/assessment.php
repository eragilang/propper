	...
	<div id="page_container"><!--page container-->
		...
		#echo "set_id:$setid|level:$segment|regional:".$_SESSION['ReGioNiD']."</br>";
            ...
            $sql =  "SELECT 
						...
						nb_question 
					FROM 
						pnp.dev_cc_category_distribution
					WHERE 
						set_id = $setid AND 
						LEVEL = $segment AND
						regional = ".$_SESSION['ReGioNiD'];
            ...
            if (mysql_num_rows($quizres) <= 0){
                ...
                echo "<div id='questionerror'>Questions is not enough! Contact Administrator (Willy B Hardjono)</div>";
                ...
                $sqlscore = "INSERT INTO dev_cc_score ".
                ...
                $sqldetail ="INSERT INTO dev_cc_score_detail ".
