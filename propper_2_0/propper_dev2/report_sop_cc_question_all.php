    ...
    //if(isset($_POST["btnReport"])){
        try{
            ...
            //if ($unitid != 0){
				...
				"	sda.set_id = 2 and qa.set_id = 2 and ".
				"	cat_group = '3.0' ".
				"GROUP BY ".
				"cat_id";
         ...
         $logger->Logging(HISTORYTYPE_VIEW_REPORT_GRAPARI,$userid,"View Report Callcenter $unitid Periode $selmonth - $selyear",$ipaddress);
...
<div class="newsletterbox">
    <form name='frmQuiz' action='report_sop_cc_question_all.php' method='post' id='frmQuiz'>
