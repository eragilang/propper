    ...
    try{
        ...
        if (($area != "0") && ($area != "")){
        	...
        	$query = "
					...
					FROM pnp.cc_score_detail_archive sda, pnp.cc_question_archive qa, pnp.cc_category cat, pnp.t_unit_branch u
					WHERE
  		...
  		echo "<table style='margin-right:5px;'>
			...
			<div id="right_column"><!--right column-->
  				<div class="section"><!--latest news-->
  					...
  					<form action="report_most_wrong_callcenter.php" method="post">
  					<?php
				try{
