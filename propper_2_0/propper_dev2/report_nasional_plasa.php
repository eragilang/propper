		...
		<div id="page_content_assess"><!--content-->
    		...
    		foreach ($arrOfplasaInRegional as $regname => $arrOfUnit){
	            ...
	            $logger->setDBConnection($gatepnp);
	     		...
	     		$logger->Logging(HistoryType::HISTORYTYPE_VIEW_REPORT_PLASA_NASIONAL,$userid,"View Report Nasional Plasa Periode $selmonth - $selyear",$ipaddress);
			...
			<div id="right_column"><!--right column-->
  				<div class="section"><!--latest news-->
  					<form action="report_nasional_plasa.php" method="post">
