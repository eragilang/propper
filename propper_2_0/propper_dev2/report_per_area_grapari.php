		...
		<div id="page_content_assess"><!--content-->
    		...
    		foreach ($arrOfShopInRegional as $regname => $arrOfUnit){
	            ...
	            $logger->setDBConnection($gatepnp);
	     		...
	     		$logger->Logging(HistoryType::HISTORYTYPE_VIEW_REPORT_GRAPARI_AREA,$userid,"View Report Per Area GraPARI $area Periode $selmonth - $selyear",$ipaddress);
					}
					?>   	
			</div><!--left column-->
			...
			<div id="right_column"><!--right column-->
  				<div class="section"><!--latest news-->
  					...
  					<form action="report_per_area_grapari.php" method="post">
  					<?php
				try{
