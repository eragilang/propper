		...
		<div id="page_content_assess"><!--content-->
			<div id="left_column"><!--left column-->
				<div id="sectiond">
  					<div id="userinfos">
  						...
  						Per Area<br />
  						<a href="report_nasional_gerai.php">Nasional</a>
		  			</div>
					  <div id="userscores">
    		...
    		foreach ($arrOfGeraiInRegional as $regname => $arrOfUnit){
	            ...
	            $logger->setDBConnection($gatepnp);
	     		...
	     		$logger->Logging(HistoryType::HISTORYTYPE_VIEW_REPORT_GERAI_AREA,$userid,"View Report Per Area Gerai $area Periode $selmonth - $selyear",$ipaddress);
					}
					?>   	
			</div><!--left column-->
			...
			<div id="right_column"><!--right column-->
  				<div class="section"><!--latest news-->
  					...
  					<form action="report_per_area_gerai.php" method="post">
  					<?php
				try{
