	...
	$gatesms = new DBGateway($conf->Host192,$conf->User192, $conf->Pass192);
        ...
        if (isset($_POST["btnReport"])){
			...
			$arrOfGeraiKPI = array();
		  	...
		  	$arrOfGeraiInRegional = array();
		  	$arrOfRegional = array();
		  	
		  	
	  	 	while($rowgrap = mysql_fetch_row($grapres)){
	  	 		
	  	 		if (!array_key_exists($rowgrap[2],$arrOfGeraiInRegional)){
	  	 			$arrOfGeraiInRegional[$rowgrap[2]] = array();
	  	 			$arrOfRegional[$rowgrap[2]] = $rowgrap[3];
	  	 		}
	  	 		
	  	 		$arrOfGeraiInRegional[$rowgrap[2]][$rowgrap[0]] = $rowgrap[0];
		...
		$arrOfGeraiKPI[$rowgrap[0]] = $rowgrap[1]."#".$nbcsr."#".$kpicsrsms1."#".$kpicsrsms2."#".$kpicsr."#".$kpi;
             }
        }
    }
    catch (Exception $e){
	...
	<div id="page_container"><!--page container-->
		...
		<div id="page_content_assess"><!--content-->
			<div id="left_column"><!--left column-->
				<div id="sectiond">
  					<div id="userinfos">
  						<a href="report_per_gerai.php">Per Gerai</a><br />
  						<a href="report_per_regional_gerai.php">Per Regional</a><br />
  						<a href="report_per_area_gerai.php">Per Area</a><br />
  						Nasional
		  			</div>
					  <div id="userscores">
  						<span style="text-decoration:underline;">Top 10 Frontliner : </span><br />
  						<a href="report_per_regional_gerai_top10.php">Regional</a> <br />
  						<a href="report_per_area_gerai_top10.php">Area</a> <br />
  						<a href="report_nasional_gerai_top10.php">Nasional</a>
		  			</div>	
				</div>
	  			<br class="clear"/>
	  			<?php
    		...
    		foreach ($arrOfGeraiInRegional as $regname => $arrOfUnit){
    			echo "<tr><th colspan='8' class='regional'>".$arrOfRegional[$regname]."</th></tr>";
    			foreach ($arrOfUnit as $unitid => $unitids){
    				list($gname, $nbcsr, $kpicsrsms1,$kpicsrsms2, $kpicsr, $kpi) = split("#", $arrOfGeraiKPI[$unitid]);
    				echo "<tr>
    							<th>$gname</th>
    							<td>$nbcsr</td>
    							<td>$kpicsr</td>
	            ...
	            $logger->setDBConnection($gatepnp);
	     		...
	     		$logger->Logging(HistoryType::HISTORYTYPE_VIEW_REPORT_GERAI_NASIONAL,$userid,"View Report Nasional Gerai Periode $selmonth - $selyear",$ipaddress);
			...
			<div id="right_column"><!--right column-->
  				<div class="section"><!--latest news-->
  					<form action="report_nasional_gerai.php" method="post">
