                        ...
                        if ($user[2] == '1'){
                            ...
                            // if number of failed attemp exceed, then lock the account
                                ...
                                $qry =  " SELECT ".
                                        ...
                                        "   emp.unit_id, ".
                                        "   job_function, ".
                                        "   if(unit_type = 'regional', 'grapari', unit_type) as unit_type, ".
                                        "   unit_name, ".
					     "	  segment, ".
				...
				//echo $qry;
						...
						$flag = "NO-RIGHT";
										...
										switch (strtoupper($userinfo[3])){
											...
											case "SUPERVISOR_E_CARE"			: $this->_level = 58; break;
											...
											//case "FRONT_OFFICE_SUPPORT"			: $this->_level = 3; break;
											...
											case "FRONT_OFFICE_SUPPORT"			: 
													if(strtoupper($userinfo[4])=='GRAPARI') {
														...
														$this->_level = 1; 
													}else if(strtoupper($userinfo[4])=='PLASA') {
														$this->_level = 3; 
													}
											 break;
											case "TEAM_LEADER"			: 
											...
											case "BE_SUPPORT"					: $this->_level = 44; break;
											case "TEAM_LEADER_BES"				: $this->_level = 44; break;
											//case "TEAM_LEADER_BES"				: $this->_level = 6; break;
										}
