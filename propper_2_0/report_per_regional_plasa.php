		...
		<div id="page_content_assess"><!--content-->
			<div id="left_column"><!--left column-->
				<div id="sectiond">
  					<div id="userinfos">
  						...
  						Per Regional<br />
  						<a href="report_per_area_plasa.php">Per Area</a> <br />
 			...
 			if (($regional != "0") && ($regional != "")){
    			...
    			foreach ($arrOfplasaKPI as $unitid => $kpiinfo){
	            ...
	            $logger->setDBConnection($gatepnp);
	     		...
	     		$logger->Logging(HistoryType::HISTORYTYPE_VIEW_REPORT_PLASA_REGIONAL,$userid,"View Report Per Regional Plasa $regional Periode $selmonth - $selyear",$ipaddress);
			...
			<div id="right_column"><!--right column-->
  				<div class="section"><!--latest news-->
  					...
  					<form action="report_per_regional_plasa.php" method="post">
  					<?php
				try{
  					$channel = "SELECT 
					  				reg_code, 
