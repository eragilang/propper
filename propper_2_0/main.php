...
<body>
	...
	<div id="page_container"><!--page container-->
		...
		<ul id="navigation"><!--navigation-->
  			...
  			<li>
			  	<a href="reportpropper.php" id="report" title="Report">
				  <span>Report</span>
				  </a>
			  </li>
  			<li>
...
<!-- 					 <div id="userscores">
					...
					<?php
					if($err == 100){
						echo "<font color=red><br><h4><span> ID Question isn't Match. <br> Please continue assessment again and Contact your administrator ! </span></h4></font>";
					} ?>
					</div>
					<?php
        ...
        <ul style="list-style-type:circle;">
	     ...
	     <li><strong style='color:red;font-size:12px;text-decoration:underline;'>Tips:</strong>Jika anda kesulitan untuk memilih pilihan jawaban, maka cukup klik text jawaban, maka pilihan yang bersesuaian akan otomatis terpilih</li>
			...
			<div id="right_column"><!--right column-->
				...
				?>
				<form action="http://10.251.38.144:9090/propper/generate_soal.php" method="post" >
				<table border="0" cellpadding="7" cellspacing="0">
					...
					<input style="background-color:silver; color: black; width:200px; height: 30px; font-size:10px;" type="submit" name='btnGenerateSoal' id='btnGenerateSoal' value = "Generate Soal CallCenter"/>
				</form>
  ...
  <input type="submit" name='btnSubmit' id='btnSubmit' value = "" class='submits' alt='Start Assessment'/>
					...
					<p>Anda sementara tidak bisa melakukan assessment. Account anda sudah di lock karena menghentikan waktu assessment. Hubungi Admin </p>
  					<?php
							...
							{
							print_r($_SESSION); echo "aku adalah $flag[0]";
					?>
						<p>Maaf, Anda tidak punya hak melakukan assessment, karena periode assessment belum dimulai atau periode assessment sudah berakhir <b>(Silahkan konfirmasi dengan regional masing - masing).</b></p>
