    ...
    try{
        ...
        if (($area != "0") && ($area != "")){
        	...
        	$query = "
					...
					FROM pnp.score_detail sda, pnp.question_archive qa, pnp.category cat, pnp.t_unit_branch u
					WHERE
  		...
  		echo "<table style='margin-right:5px;'>
			...
			<div id="right_column"><!--right column-->
  				<div class="section"><!--latest news-->
  					...
  					<form action="report_most_wrong.php" method="post">
  					<?php
				try{
